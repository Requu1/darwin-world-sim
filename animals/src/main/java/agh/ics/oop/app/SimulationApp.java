...
import agh.ics.oop.map.FileMapDisplay;
import agh.ics.oop.map.RectangularMap;
import agh.ics.oop.presenters.SimulationPresenter;
import agh.ics.oop.presenters.SimulationStatisticsPresenter;
...
public class SimulationApp extends Application {
    ...
    public void launchSimulation(RectangularMap map, Simulation simulation) throws IOException {
        ...
        stage.setTitle("Simulation app for MapID: " + map.getId());
        stage.show();
    ...
    private void launchSimulationStatistics(Simulation simulation, UUID mapID) throws IOException {
        ...
        Stage stage = new Stage();
        configureStage(stage, viewRoot);
        stage.setTitle("Simulation statistics for MapID: " + mapID);
        stage.show();
        stage.setOnCloseRequest(_ ->
                simulation.removeListener(presenter));
